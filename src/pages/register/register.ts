...
export class RegisterPage {
  ...
  image: string = 'assets/images/logo.png'; // setting a default image (optional)
  ...
  getPicture() {
    const options: CameraOptions = {
      ...
      allowEdit: true,
      destinationType: this.camera.DestinationType.FILE_URI, //FILE_URI file location on the device.
